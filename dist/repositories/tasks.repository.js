...
class TasksRepository extends base_repository_1.default {
    ...
    findAll() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return yield _super.findAll.call(this);
        });
    }
    findById(id) {
        const _super = Object.create(null, {
    ...
    create(task) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return yield _super.create.call(this, task);
        });
    }
    update(id, updatedTask) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return yield _super.update.call(this, id, updatedTask);
        });
    }
    delete(id) {
        const _super = Object.create(null, {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return yield _super.delete.call(this, id);
        });
    }
}
